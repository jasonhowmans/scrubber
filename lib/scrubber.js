;(function ($) {
  ...
  // Update marker time
  //
  // For calculating and updating the .scrubber-time-cursor element content 
  // and position. Also updates the CURSOR_TIME variable
  function updateMarkerTime () {
    ...
    if (_time) {
      CURSOR_TIME = _time;
      $('.scrubber-time-cursor .scrubber-time-label', TIME_MARKERS).text(_time.hh+':'+_time.mm+':'+_time.ss);
      $('.scrubber-time-cursor', TIME_MARKERS).css('left', (_width_ratio*100)+'%');
    }
  }
